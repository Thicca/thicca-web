...
<html lang="ja">
  ...
  <body>
    ...
    <main>
      ...
      <div class="form-area">
        <p class="head-text">
          現在、下記のお仕事を受け付けています。<br>
          <br>
          <b>・イラスト依頼（漫画 / 一枚絵 / ミニキャラ 他）</b><br>
          　※ご依頼イラストのテイストについては<a href='gallery'>『イラスト一覧』ページ</a>をご参考いただき、ご要望をお伝えください（「あのイラストみたいに描いて欲しい！」等）。<br>
          　※法人様のみ。個人様は要相談。<br>
          　※原則、個人の方は<a href='https://skeb.jp/@thicca_view' target='_blank' rel='noopener noreferrer'>Skeb</a>からご依頼ください。<br>
          　※Live2Dモデリングは現在受け付けておりません。<br>
          <b>・配信・動画への出演（『デュエル・マスターズ』関連 / 『デュエル・マスターズ プレイス』関連 / 他カードゲーム関連 / ストリーマーサーバー(スト鯖)関連 他）</b><br>
          　※原則、VTuber『夢毬てちか』としてお受けしますが、場合によっては活動者『てぃっか』としてお受けすることもできます。<br>
          <b>・カードゲームイベントへの参加（『デュエル・マスターズ』関連 / 『デュエル・マスターズ プレイス』関連 他）</b><br>
          　※活動者『てぃっか』としても、VTuber『夢毬てちか』としてもお受けできます。<br>
          　※私が遊べるカードゲームについては<a href='profile#deck'>『プロフィール』ページの『所持デッキ』</a>をご参考ください。<br>
          <br>
