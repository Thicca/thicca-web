...
<html lang="ja">
  <head>  
    <meta charset="utf-8">
    <title>Products | Interior Design</title>
    <meta name="description" content="Interior Designの商品一覧ページです。私たちがデザインするオリジナルのソファ、デスク、チェア、ダイニングなどのインテリアについてご紹介します。">
  ...
  <body>
    ...
    <main>
      ...
      <ul class="products-list all">
        <li>
          <img src="images/products/products1.jpg" alt="">
          <div class="info">
        ...
        <li>
          <img src="images/products/products2.jpg" alt="">
          <div class="info">
        ...
        <li>
          <img src="images/products/products3.jpg" alt="">
          <div class="info">
        ...
        <li>
          <img src="images/products/products4.jpg" alt="">
          <div class="info">
        ...
        <li>
          <img src="images/products/products5.jpg" alt="">
          <div class="info">
        ...
        <li>
          <img src="images/products/products6.jpg" alt="">
          <div class="info">
        ...
        <li>
          <img src="images/products/products7.jpg" alt="">
          <div class="info">
        ...
        <li>
          <img src="images/products/products8.jpg" alt="">
          <div class="info">
        ...
        <li>
          <img src="images/products/products9.jpg" alt="">
          <div class="info">
        ...
        <li>
          <img src="images/products/products10.jpg" alt="">
          <div class="info">
        ...
        <li>
          <img src="images/products/products11.jpg" alt="">
          <div class="info">
        ...
        <li>
          <img src="images/products/products12.jpg" alt="">
          <div class="info">
        ...
        <li>
          <img src="images/products/products13.jpg" alt="">
          <div class="info">
        ...
        <li>
          <img src="images/products/products14.jpg" alt="">
          <div class="info">
        ...
        <li>
          <img src="images/products/products15.jpg" alt="">
          <div class="info">
