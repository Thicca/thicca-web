...
<html lang="ja">
  <head>  
    <meta charset="utf-8">
    <title>Works | Interior Design</title>
    <meta name="description" content="Interior Designの実績紹介ページです。住む人やその空間を利用されるお客様が笑顔になるような空間創りをお手伝いさせていただきます。">
  ...
  <body>
    ...
    <main>
      <div class="page-header">
        <div class="img">
          <img src="images/works/techika_kfb.png" alt="">
        </div>
      ...
      <ul class="works-list">
        <li class="work1">
          <div class="img">
            <img src="images/works/works1-1.jpg" alt="">
          </div>
          <div class="text">
            ...
            <div class="modal-open">More Images<img src="images/works/icon-modal-open.svg" alt=""></div>
          </div>

          <div class="modal-container">
            <div class="modal-content">
              <div class="modal-close"><img src="images/works/icon-modal-close.svg" alt=""></div>
              <p class="modal-name">PROJECT NAME NO.001</p>
              <div class="modal-img">
                <img src="images/works/works1-1.jpg" alt="">
                <img src="images/works/works1-2.jpg" alt="">
                <img src="images/works/works1-3.jpg" alt="">
                <img src="images/works/works1-4.jpg" alt="">
              </div>
            </div>
          </div>
        </li>
        ...
        <li class="work2">
          <div class="img">
            <img src="images/works/works2-1.jpg" alt="">
          </div>
          <div class="text">
          ...
          <div class="modal-container">
            <div class="modal-content">
              ...
              <div class="modal-img">
                <img src="images/works/works2-1.jpg" alt="">
                <img src="images/works/works2-2.jpg" alt="">
                <img src="images/works/works2-3.jpg" alt="">
                <img src="images/works/works2-4.jpg" alt="">
              </div>
            </div>
          </div>
        </li>
        ...
        <li class="work3">
          <div class="img">
            <img src="images/works/works3-1.jpg" alt="">
          </div>
          <div class="text">
          ...
          <div class="modal-container">
            <div class="modal-content">
              ...
              <div class="modal-img">
                <img src="images/works/works3-1.jpg" alt="">
                <img src="images/works/works3-2.jpg" alt="">
                <img src="images/works/works3-3.jpg" alt="">
                <img src="images/works/works3-4.jpg" alt="">
              </div>
            </div>
          </div>
        </li>
